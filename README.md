...
- Bots: `API_BASE_URL=http://localhost:3001`, `WS_URL=ws://localhost:3001/ws`, `BOT_USER_ID=market-maker-1`, `NUM_TAKERS=75`, `LEVEL_SIZES=25,50,100,150,250`, `RATE_LIMIT_TPS=6`, `MIN_INTERVAL_MS=250`, `MAX_INTERVAL_MS=1500`, `REQUOTE_FAIR_MOVE_CENTS=1`, `SIZE_JITTER_MIN=0.75`, `SIZE_JITTER_MAX=1.35`, `REQUOTE_JITTER_RATIO=0.10`, `FAIR_VALUE_VOL_SCALE_CENTS=25000`.
